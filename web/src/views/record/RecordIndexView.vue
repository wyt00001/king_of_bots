    ...
    <table class="table table-striped table-hover" style="text-align:center">
      ...
      <tbody>
        <tr v-for="record in records" :key="record.record.id">
          <td> <img :src="record.a_photo" alt="" class="record-user-photo">
            &nbsp;<!--空格的符号-->
            <span class="record-user-name">{{ record.a_username }}</span>
          </td>
          <td> <img :src="record.b_photo" alt="" class="record-user-photo">
            &nbsp;
...
export default {
  ...
  setup() {
    ...
    const pull_page = page => {
      current_page = page;
      $.ajax({
        url: 'https://app7634.acapp.acwing.com.cn/api/record/getlist/',
        data: {
          page,
        },
        type: 'GET',
