<template>
    <div class="menu-field">
        <div class="menu">
            <div class="menu-item" @click="click_pk_handler">
                对战
            </div>
            <div class="menu-item" @click="click_record_handler">
                对局列表
            </div>
            <div class="menu-item" @click="click_ranklist_handler">
                排行榜
            </div>
            <div class="menu-item" @click="click_user_bot_handler">
                我的Bot
            </div>
        </div>
    </div>
